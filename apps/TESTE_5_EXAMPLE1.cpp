//THIS CODE IMPLEMENTATION SIMULATES THE DOPPLER EFFECT WHEN A MICROPHONE MOVES AWAY FROM A STATIONARY SOURCE WITH A CONSTANT ACCELERATION (VELOCITY INCREASES).
