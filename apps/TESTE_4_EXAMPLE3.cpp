//THIS CODE IMPLEMENTATION SIMULATES THE DOPPLER EFFECT WHEN A SOURCE APPROACHES A STATIONARY MICROPHONE WITH A CONSTANT VELOCITY, PASSES BY THE MICROPHONE AND THEN MOVES FURTHER AWAY.
...
int main(){
    ...
    //start with 1 source
        sources_vec.push_back(Source(0.5, source_frequency, 44100, bufferSize, 0.0, 0, 0));
