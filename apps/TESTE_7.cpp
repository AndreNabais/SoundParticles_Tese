//THIS CODE IMPLEMENTATION SIMULATES THE SONIC BOOM PHENOMENON THAT HAPPENS WHEN A SUPERSONIC SOURCE PASSES BY A STATIONARY MICROPHONE AT ANY SPATIAL COORDINATE
//THIS TEST SIMULATES A SUPERSONIC JET (THE MICROPHONE, WHICH SIMULATES THE LISTENER, WILL ALWAYS REMAIN ON THE GORUND), SO THE SONIC BOOM DOESN'T NECESSARILY HAPPEN AT VELOCITIES GREATER THAN SPEED OF SOUND, IT WILL ALSO DEPEND ON THE HEIGHT OF THE PLANE.
...
int main(){
    ...
    //start with 1 source
        sources_vec.push_back(Source(0.5, source_frequency, 44100, bufferSize, -12.0, 5.0, 0.0));
